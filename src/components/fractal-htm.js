...
//  static icon = 'icons:description'
  ...
  static get template(){
    return `
      ...
      <link rel="stylesheet" href="//${Cfg.server}/design/interface.css" type="text/css">
      <link rel="stylesheet" href="//${Cfg.server}/design/textEditor.css" type="text/css">
      <link rel="stylesheet" href="//${Cfg.server}/design/passion.css" type="text/css">
  ...
  initEditor(){
	...
	this.article.addEventListener('blur', ev => {
      ...
      if(this.article.innerHTML == this.article.prevHTML) return;
